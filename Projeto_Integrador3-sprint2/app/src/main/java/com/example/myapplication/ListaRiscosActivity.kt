...
class ListaRiscosActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val listaRiscos = listOf(
            Risco("Risco 1", "01/05/2025", "Local A", ""),
            Risco("Risco 2", "02/05/2025", "Local B", ""),
            Risco("Risco 3", "03/05/2025", "Local C", ""),
            Risco("Risco 4", "04/05/2025", "Local D", ""),
            Risco("Risco 5", "05/05/2025", "Local E", ""),
            Risco("Risco 6", "06/05/2025", "Local F", "")
        )
